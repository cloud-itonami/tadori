(ns tadori.cells.social-post.state-machine
  "Phase state machine for the 辿 — Trace (authorized on-chain transaction tracing + actor attribution) social_post cell — the publication membrane that
